            ...
            <div class="offcanvas offcanvas-end text-bg-white" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body justify-content-between">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Tambah Event</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="card shadow-sm p-4">
                ...
                <form method="POST" action="#" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="lapangan_images" name="lapangan_images[]" multiple required>
                    </div>
    
                    <!-- Nama Lapangan -->
                    <div class="mb-3">
                        <label for="lapangan_name" class="form-label">Nama Lapangan</label>
                        <input type="text" class="form-control" id="lapangan_name" name="lapangan_name" placeholder="Contoh: Lapangan Futsal MDP" required>
                    </div>
    
                    <!-- Jumlah Lapangan -->
                    <div class="mb-3">
                        <label for="jumlah_lapangan" class="form-label">Tipe Lapanga(Contoh: A/B/C)</label>
                        <input type="text" class="form-control" id="jumlah_lapangan" name="jumlah_lapangan" placeholder="Contoh: A,B,C" required>
                    </div>
    
                    <!-- Deskripsi -->
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">Deskripsi & Fasilitas Lapangan</label>
                        <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Contoh: Rumput sintetis, ruang tunggu, toilet, parkir luas" required></textarea>
                    </div>
    
                    <!-- Jam Aktif -->
                    <div class="mb-3">
                        <label for="jam_aktif" class="form-label">Jam Aktif</label>
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <label for="jam_buka" class="form-label">Jam Buka</label>
                                <input type="time" class="form-control" id="jam_buka" name="jam_buka" required onchange="checkAvailability()">
                            </div>
                            <div class="col-md-6 mb-2">
                                <label for="jam_tutup" class="form-label">Jam Tutup</label>
                                <input type="time" class="form-control" id="jam_tutup" name="jam_tutup" required onchange="checkAvailability()">
                            </div>
                        </div>
                        <small class="text-muted">Pelanggan hanya bisa memilih jam yang kosong nanti</small>
                        <div id="warningMessage" class="mt-2 text-danger" style="display:none;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="harga" name="harga" placeholder="Contoh: 150000" required>
                    </div>
